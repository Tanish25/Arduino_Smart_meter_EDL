...
//remove this
volatile float Volts = 42.1;
volatile float curr = 34.6;
volatile float poww = 78.44;
...
void Send_to_thingspeak( float Voltage, float Current, float Power )
{
  char Get_string[128];
  char len_string[128];
  uint8_t len;
  sprintf(Get_string, "GET https://api.thingspeak.com/update?api_key=%s&field1=%e&field2=%e&field3=%e\r\n",API_KEY,Voltage,Current,Power);
